...
function PLAYER:Spawn()
	...
	self.Player:SetPlayerColor( Vector( self.Player:GetInfo( "cl_playercolor" ) ) )
end
...
function PLAYER:SetModel()
	util.PrecacheModel( "models/boreas_cbrn/boreas_cbrn.mdl" )
    self.Player:SetModel( "models/boreas_cbrn/boreas_cbrn.mdl" )
end
...
player_manager.RegisterClass( "guard_marksman", PLAYER, "player_default" )
