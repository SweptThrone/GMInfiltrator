...
PLAYER.SlowWalkSpeed = 100 * 0.9
PLAYER.WalkSpeed = 160 * 0.9
PLAYER.RunSpeed = 280 * 0.9
...
player_manager.RegisterClass( "guard_assault", PLAYER, "player_default" )
