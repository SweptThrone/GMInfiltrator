...
SWEP.Manufacturer = "Pieta Bardotta"
SWEP.Contact				= ""
SWEP.Purpose				= ""
SWEP.Instructions				= ""
SWEP.MuzzleAttachment			= "1" 	-- Should be "1" for CSS models or "muzzle" for hl2 models
SWEP.ShellEjectAttachment			= "2" 	-- Should be "2" for CSS models or "1" for hl2 models
SWEP.PrintName				= "Cavalry 5.56"		-- Weapon name (Shown on HUD)	
...
sound.Add({
	name = 			"SWeapon_FAMAS.1",
	channel = 		CHAN_WEAPON,
	level = 140,
	sound = 			"^weapons/srp6/clarion-1_css.wav"
})
sound.Add({
	name = 			"SWeapon_FAMAS.fp.1",
	channel = 		CHAN_WEAPON,
	level = 140,
	sound = 			"weapons/famas/famas-1.wav"
})
if CLIENT then SWEP.WepSelectIcon = surface.GetTextureID( "vgui/gfx/vgui/famas" ) end
SWEP.Primary.Sound_World			= Sound("SWeapon_FAMAS.1")		-- Script that calls the primary fire sound
SWEP.Primary.Sound			= Sound("SWeapon_FAMAS.fp.1")		-- Script that calls the primary fire sound
...
SWEP.BlowbackBoneMods = {
	["Charging Handle"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 3.4), angle = Angle(0, 0, 0) },
}

-- Enter iron sight info and bone mod info below
SWEP.IronSightsPos = Vector(-6.24, -10, 0.119)
SWEP.IronSightsAng = Vector(1, 0, -1.5)
...
SWEP.Primary.Velocity = 930 * 3.28
