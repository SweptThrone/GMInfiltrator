...
SWEP.PrintName				= "Snooper SMG (S)"		-- Weapon name (Shown on HUD)	
SWEP.Slot				= 0				-- Slot in the weapon selection menu
SWEP.SlotPos				= 76			-- Position in the slot
SWEP.DrawAmmo				= true		-- Should draw the default HL2 ammo counter
SWEP.DrawWeaponInfoBox			= false		-- Should draw the weapon info box
SWEP.BounceWeaponIcon   		= 	false	-- Should the weapon icon bounce?
SWEP.DrawCrosshair = true --			= true		-- set false if you want no crosshair
...
if CLIENT then SWEP.WepSelectIcon = surface.GetTextureID( "vgui/gfx/vgui/tmp" ) end
sound.Add({
	name = 			"SWeapon_TMP.1",
	channel = 		CHAN_WEAPON,
	level = 80,
	sound = 			"^weapons/srp6/smp-1_css.wav"
})
sound.Add({
	name = 			"SWeapon_TMP.fp.1",
	channel = 		CHAN_WEAPON,
	level = 80,
	sound = 			"weapons/tmp/tmp-1.wav"
})
SWEP.Primary.Sound_World			= Sound("SWeapon_TMP.1")		-- Script that calls the primary fire sound
SWEP.Primary.Sound			= Sound("SWeapon_TMP.fp.1")		-- Script that calls the primary fire sound
...
SWEP.Primary.IronAccuracy = 0.012 -- Ironsight accuracy, should be the same for shotguns
...
SWEP.IronSightsPos = Vector(-6.841, -10, 1.44)
