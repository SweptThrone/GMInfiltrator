...
SWEP.PrintName				= "Gladiator Heavy Rifle"		-- Weapon name (Shown on HUD)	
...
sound.Add({
	name = 			"SWeapon_Galil.1",
	channel = 		CHAN_WEAPON,
	level = 140,
	sound = 			"^weapons/srp6/defender-1_css.wav"
})
sound.Add({
	name = 			"SWeapon_Galil.fp.1",
	channel = 		CHAN_WEAPON,
	level = 140,
	sound = 			"weapons/galil/galil-1.wav"
})
if CLIENT then SWEP.WepSelectIcon = surface.GetTextureID( "vgui/gfx/vgui/galil" ) end
SWEP.Primary.Sound_World			= Sound("SWeapon_Galil.1")		-- Script that calls the primary fire sound
SWEP.Primary.Sound			= Sound("SWeapon_Galil.fp.1")		-- Script that calls the primary fire sound
...
SWEP.Primary.Spread		= 0.028	-- Define from-the-hip accuracy 1 is terrible, .0001 is exact)
SWEP.Primary.IronAccuracy = 0.014 -- Ironsight accuracy, should be the same for shotguns
...
SWEP.BlowbackBoneMods = {
	["galil_bolt"] = { scale = Vector(1, 1, 1), pos = Vector(0, -2.7, 0), angle = Angle(0, 0, 0) },
}

-- Enter iron sight info and bone mod info below
SWEP.IronSightsPos = Vector(-6.281, -12, 1.32)
...
SWEP.Primary.Velocity = 950 * 3.28
