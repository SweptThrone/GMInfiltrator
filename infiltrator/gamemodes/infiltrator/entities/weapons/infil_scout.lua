...
sound.Add({
	name = 			"SWeapon_Scout.1",
	channel = 		CHAN_WEAPON,
	level = 140,
	sound = 			"^weapons/srp6/scout-1_css.wav"
})
sound.Add({
	name = 			"SWeapon_Scout.fp.1",
	channel = 		CHAN_WEAPON,
	level = 140,
	sound = 			"weapons/scout/scout_fire-1.wav"
})
if CLIENT then SWEP.WepSelectIcon = surface.GetTextureID( "vgui/gfx/vgui/scout" ) end
SWEP.Primary.Sound_World			= Sound("SWeapon_Scout.1")
SWEP.Primary.Sound			= Sound("SWeapon_Scout.fp.1")
