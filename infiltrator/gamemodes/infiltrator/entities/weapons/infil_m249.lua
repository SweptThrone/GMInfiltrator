...
SWEP.PrintName				= "Sledge"		-- Weapon name (Shown on HUD)	
...
sound.Add({
	...
	channel = CHAN_WEAPON,
	level = 140,
	sound = "^weapons/srp6/m249-2_css.wav"
})
sound.Add({
	name = "SWeapon_M249.fp.1",
	channel = CHAN_WEAPON,
	level = 140,
	sound = "weapons/m249/m249-1.wav"
})

if CLIENT then SWEP.WepSelectIcon = surface.GetTextureID( "vgui/gfx/vgui/m249" ) end
SWEP.Primary.Sound		= Sound("SWeapon_M249.fp.1")
SWEP.Primary.Sound_World		= Sound("SWeapon_M249.1")
...
SWEP.Primary.Spread		= 0.0366	-- Define from-the-hip accuracy 1 is terrible, .0001 is exact)
...
SWEP.EventTable = {
	[ACT_VM_RELOAD] = {
		{ ["time"] = 4, ["type"] = "lua", ["value"] = function( wep, viewmodel, ifp ) 
			wep:CompleteReload()
...
SWEP.Primary.Velocity = 915 * 3.28
