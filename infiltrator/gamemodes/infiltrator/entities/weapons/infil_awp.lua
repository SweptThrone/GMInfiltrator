...
SWEP.PrintName				= "Precision 300"		-- Weapon name (Shown on HUD)	
...
sound.Add({
	...
	channel = 		CHAN_WEAPON,
	level = 140,
	sound = 			"^weapons/srp6/magnum-1_css.wav"
})
sound.Add({
	name = 			"SWeapon_AWP.fp.1",
	channel = 		CHAN_WEAPON,
	level = 140,
	sound = 			"weapons/awp/awp1.wav"			
})

if CLIENT then SWEP.WepSelectIcon = surface.GetTextureID( "vgui/gfx/vgui/awp" ) end
SWEP.Primary.Sound_World = Sound("SWeapon_AWP.1")
SWEP.Primary.Sound = Sound("SWeapon_AWP.fp.1")
...
SWEP.Primary.Ammo			= "SniperPenetratedRound" -- .338 Lapua Magnum
...
SWEP.Secondary.ScopeTable =
	{
		...
		ScopeMaterial = Material("scope/nerf_sniper.png"),
		ScopeOverlay = nil,
...
SWEP.Primary.Damage		= 143	--base damage per bullet
SWEP.Primary.Spread		= 0.07	--define from-the-hip accuracy 1 is terrible, .0001 is exact)
SWEP.Primary.IronAccuracy = 0.0001 -- ironsight accuracy, should be the same for shotguns

--SWEP.BoltAction	=	true
-- enter iron sight info and bone mod info below
SWEP.IronSightsPos = Vector(-7.441, -11.36, 2.319)
...
SWEP.IronSightsMoveSpeed = SWEP.MoveSpeed * 0.375

SWEP.RangeCaliber = ".338 Lapua"
...
SWEP.Primary.Velocity = 850 * 3.28
