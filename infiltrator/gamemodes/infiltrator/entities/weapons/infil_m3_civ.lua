...
SWEP.PrintName				= "Hammerhead 12G (Civ)"		-- Weapon name (Shown on HUD)	
...
SWEP.IronSightsPos = Vector(2.684, -0.5, 1.08)
SWEP.IronSightsAng = Vector(0.1, 0, 0)
SWEP.RunSightsPos = Vector(-3.481, -5.88, 1.279)
SWEP.RunSightsAng = Vector(-11.5, -45.401, 0)
SWEP.InspectPos = Vector(-5.801, -5.72, -0.721)
SWEP.InspectAng = Vector(23.899, -45.201, -8.101)
