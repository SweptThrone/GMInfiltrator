...
SWEP.PrintName				= "Warlord 223"		-- Weapon name (Shown on HUD)	
...
sound.Add({
	name = 			"SWeapon_SG552.1",
	channel = 		CHAN_WEAPON,
	level = 140,
	sound = 			"^weapons/srp6/krieg552-1_css.wav"
})
sound.Add({
	name = 			"SWeapon_SG552.fp.1",
	channel = 		CHAN_WEAPON,
	level = 140,
	sound = 			"weapons/sg552/sg552-1.wav"
})
if CLIENT then SWEP.WepSelectIcon = surface.GetTextureID( "vgui/gfx/vgui/sg552" ) end

SWEP.Primary.Sound_World			= Sound("SWeapon_SG552.1")		-- script that calls the primary fire sound
SWEP.Primary.Sound			= Sound("SWeapon_SG552.fp.1")		-- script that calls the primary fire sound
...
SWEP.Primary.KickHorizontal			= .125		-- Maximum up recoil (stock)
...
SWEP.IronSightsPos = Vector(-7.841, -19.08, 2.559)
